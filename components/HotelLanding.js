        ...
        <Layout navbarProps={{ logo: hotel.logoUrl, brandName: hotel.heroTitle ? hotel.name : 'BookingKub' }}>
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                        <div className="space-y-2">
                            <div className="text-blue-600 font-bold tracking-[0.2em] uppercase text-xs animate-fade-in-up">Accommodations</div>
                            <h2 className="text-4xl md:text-5xl font-display font-bold text-slate-900 leading-tight">{t('landing.findSanctuary')}</h2>
                        </div>
                        <Link href={`/search?${defaultParams}`} className="group flex items-center gap-2 text-slate-600 hover:text-blue-600 font-medium transition-colors pb-2">
                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        ...
                        <div className="flex-1 order-2 lg:order-1 space-y-8 animate-fade-in-left">
                            <div className="space-y-4">
                                <span className="text-blue-600 font-bold tracking-[0.2em] uppercase text-xs">{t('landing.ourAmenities')}</span>
            ...
            <section className="py-24 relative overflow-hidden bg-slate-900 text-white">
                <div className="absolute inset-0">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-blue-900/90 to-slate-900/80" />
                </div>
                ...
                <div className="container mx-auto px-4 text-center relative z-10">
                    ...
                    >
                        ...
                        <Link href={`/search?${defaultParams}`} className="inline-flex items-center gap-3 bg-white text-blue-900 font-bold text-lg px-10 py-5 rounded-full shadow-2xl hover:scale-105 hover:bg-blue-50 transition-all duration-300">
