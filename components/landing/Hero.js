...
export default function Hero({ title, description, ctaText }) {
    ...
    return (
        <div className="relative overflow-hidden bg-[#0A0F1C] pt-6 pb-24">
            ...
            <div className="absolute bottom-10 right-1/4 w-[500px] h-[500px] bg-blue-500/15 rounded-full blur-[120px] mix-blend-screen animate-pulse-slow" style={{ animationDelay: '2s' }} />
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-4xl mx-auto text-center space-y-8 pt-16">
                    ...
                    >
                        <span className="flex items-center gap-2"><CheckCircle size={16} className="text-blue-500" /> No Credit Card Required</span>
                        <span className="flex items-center gap-2"><CheckCircle size={16} className="text-blue-500" /> Cancel Anytime</span>
                        <span className="flex items-center gap-2"><CheckCircle size={16} className="text-blue-500" /> Free Support</span>
                    </motion.div>
                </div>
                ...
                >
                    <div className="absolute -inset-1 bg-gradient-to-r from-primary-500 to-blue-500 rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-1000"></div>
                    <motion.div
                        animate={{ y: [0, -10, 0] }}
